...
defined('BASEPATH') or exit('No direct script access allowed');
	...
	class Setips extends CI_Controller{
		...
		public function penyisihan(){
			...
			$data['soal'] = $isinya;
			$this->load->view('V_Soalips', $data);			
	}
	function hitung(){
				$benar = 0;
				$salah = 0;
				$kosong = 0;
				$kunci = $this->db->query('SELECT idsoal,kunci from soalips');
				$kunci1 = $kunci->result();
				$kunciakhir = array();
