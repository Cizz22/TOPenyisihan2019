...
defined('BASEPATH') or exit('No direct script access allowed');
	...
	class Setmat extends CI_Controller{
		...
		public function penyisihan(){
			...
			$data['soal'] = $isinya;
			$this->load->view('V_Soalmat', $data);			
	}
	function hitung(){
				$benar = 0;
				$salah = 0;
				$kosong= 0;
				$kunci = $this->db->query('SELECT idsoal,kunci from soalmat');
				$kunci1 = $kunci->result();
				$kunciakhir = array();
